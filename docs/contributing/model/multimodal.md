...
=== "Basic example: LLaVA"
    ...
    ??? code
        ...
        ```python
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/llava/modeling_llava.py#L530-L544
    ...
    ??? code
        ...
        ```python
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/llava/modeling_llava.py#L290-L300
    ...
    ```python
    # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/clip/modeling_clip.py#L1094-L1102
    ...
    ??? code
        ...
        ```python
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/clip/modeling_clip.py#L247-L257
    ...
    ```python
    # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/clip/modeling_clip.py#L195-L196
...
=== "No input placeholders: Fuyu"
    ...
    ??? code
        ...
        ```python
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/fuyu/modeling_fuyu.py#L311-L322
    ...
    ??? code
        ...
        ```python
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/fuyu/processing_fuyu.py#L541-L544
        image_encoding = self.image_processor.preprocess(images, **output_kwargs["images_kwargs"])
        batch_images = image_encoding["images"]
        image_unpadded_heights = image_encoding["image_unpadded_heights"]
        image_unpadded_widths = image_encoding["image_unpadded_widths"]

        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/fuyu/image_processing_fuyu.py#L480-L
        if do_resize:
            batch_images = [
    ...
    ??? code
        ...
        ```python
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/fuyu/processing_fuyu.py#L417-L425
        ...
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/fuyu/image_processing_fuyu.py#L638-L658
    ...
    ??? code
        ...
        ```python
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/fuyu/image_processing_fuyu.py#L552-L562
...
=== "Basic example: LLaVA"
    ...
    ```python
    # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/clip/image_processing_clip.py#L339-L345
    images = [
...
=== "With postprocessing: Fuyu"
    ...
    ```python
    # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/fuyu/image_processing_fuyu.py#L673-L679
...
=== "Basic example: LLaVA"
    ...
    ```python
    # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/llava/processing_llava.py#L167-L170
    prompt_strings = []
    for sample in text:
...
=== "Handling additional tokens: Fuyu"
    ...
    ??? code
        ...
        ```python
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/fuyu/processing_fuyu.py#L417-L435
        model_image_input = self.image_processor.preprocess_with_tokenizer_info(
            image_input=tensor_batch_images,
            image_present=image_present,
            image_unpadded_h=image_unpadded_heights,
