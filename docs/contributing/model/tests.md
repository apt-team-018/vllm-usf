...
These tests compare the model outputs of vLLM against [HF Transformers](https://github.com/apt-team-018/transformers-usf.git). You can add new tests under the subdirectories of <gh-dir:tests/models>.
