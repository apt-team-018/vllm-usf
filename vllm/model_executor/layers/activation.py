...
class SwigluOAIAndMul(CustomOp):
    # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/gpt_oss/modeling_gpt_oss.py#L106-L110
...
class QuickGELU(CustomOp):
    # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/activations.py#L90
    def __init__(self):
        super().__init__()
        if current_platform.is_cuda_alike() or current_platform.is_cpu():
