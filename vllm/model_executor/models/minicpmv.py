...
# Adapted from
# https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/llama/modeling_llama.py
...
class MiniCPMVProcessingInfo(BaseProcessingInfo):
    ...
    def get_hf_processor(self, **kwargs: object):
        ...
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/image_transforms.py#L428
