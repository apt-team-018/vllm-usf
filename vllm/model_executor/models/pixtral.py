...
# Based off https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/pixtral/modeling_pixtral.py
...
class PixtralHFEncoderInfo(VisionEncoderInfo[PixtralVisionConfig]):
    ...
    # Adapted from: https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/pixtral/image_processing_pixtral.py#L99
