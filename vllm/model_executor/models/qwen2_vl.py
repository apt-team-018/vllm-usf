...
# Adapted from
# https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/qwen2_vl/modeling_qwen2_vl.py
...
class Qwen2VLProcessingInfo(BaseProcessingInfo):
    ...
    def _get_vision_info(
        ...
        *,
        ...
        # https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/qwen2_vl/image_processing_qwen2_vl.py#L294
