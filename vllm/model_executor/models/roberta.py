...
def replace_roberta_positions(input_ids: torch.Tensor,
    ...
    # References:
    # - https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/roberta/modeling_roberta.py#L133
    # - https://github.com/apt-team-018/transformers-usf/blob/main/src/transformers/models/roberta/modeling_roberta.py#L1669
